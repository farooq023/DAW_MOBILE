...
class ForwardWfLandscape extends StatefulWidget {
  @override
  State<ForwardWfLandscape> createState() => _ForwardWfLandscapeState();
}

class _ForwardWfLandscapeState extends State<ForwardWfLandscape> {
  ...
  Widget build(BuildContext context) {
    ...
    var modalBodyHeight = mHeight * 0.74;
    var lang = AppLocalizations.of(context)!;

    var marginTop = mHeight * 0.04;

    var labelSize = mWidth * 0.03;
    var textSize = mWidth * 0.02;

    var iconSize = mWidth * 0.035;
    var iconSize2 = mWidth * 0.025;
    var innerPadding = mWidth * 0.03;
    var containerBorderRadius = mWidth * 0.03;

    var boxHeight = mHeight * 0.55;
    ...
    showAlertDialog() {
      return showDialog<void>(
        ...
        builder: (BuildContext context) {
          return IncompleteEntriesTablet(mHeight * 0.2, mWidth * 0.4, textSize, incompleteEntries, iconSize);
        },
      );
    }
